...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SECTIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SECTIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SECTIE actions', async () => {
      const arg = { id: 14081 };
    ...
    it('dispatches UPDATE_SECTIE actions', async () => {
      const arg = { id: 14081 };
    ...
    it('dispatches PARTIAL_UPDATE_SECTIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SECTIE actions', async () => {
      const arg = 42666;
